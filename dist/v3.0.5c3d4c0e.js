...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/v3.0/views/UserForm.ts":[function(require,module,exports) {
"use strict";
...
var UserForm = /*#__PURE__*/function () {
  function UserForm(parent, model) {
    ...
    this.parent = parent;
    this.model = model; // 为啥要用箭头函数？打印this一看便知
...
},{}],"src/v3.0/models/Model.ts":[function(require,module,exports) {
"use strict";
...
var Car = /*#__PURE__*/_createClass( //engine: Engine;
//constructor() {
...
},{}],"src/v3.0/models/Attributes.ts":[function(require,module,exports) {
"use strict";
...
var Attributes = /*#__PURE__*/function () {
  function Attributes(data) {
    ...
    this.data = data; //get(propName: string): string | number {
...
},{}],"src/v3.0/models/Eventing.ts":[function(require,module,exports) {
"use strict";
...
exports.Eventing = void 0; // 注意函数表达式的使用
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/v3.0/models/ApiSync.ts":[function(require,module,exports) {
"use strict";
...
},{"axios":"node_modules/axios/index.js"}],"src/v3.0/models/Collection.ts":[function(require,module,exports) {
"use strict";
...
},{"./Eventing":"src/v3.0/models/Eventing.ts","axios":"node_modules/axios/index.js"}],"src/v3.0/models/User.ts":[function(require,module,exports) {
"use strict";
...
var rootUrl = 'http://localhost:3000/users'; // use inheritance not composition to refactor
...
*/
},{"./Model":"src/v3.0/models/Model.ts","./Attributes":"src/v3.0/models/Attributes.ts","./Eventing":"src/v3.0/models/Eventing.ts","./ApiSync":"src/v3.0/models/ApiSync.ts","./Collection":"src/v3.0/models/Collection.ts"}],"src/v3.0/index.ts":[function(require,module,exports) {
"use strict";
...
userForm.render();
},{"./views/UserForm":"src/v3.0/views/UserForm.ts","./models/User":"src/v3.0/models/User.ts"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/v3.0/index.ts"], null)
//# sourceMappingURL=/v3.0.5c3d4c0e.js.map